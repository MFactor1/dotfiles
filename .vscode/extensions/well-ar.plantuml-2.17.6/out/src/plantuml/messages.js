    ...
    static showUpdateMessage(version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result === viewReleaseNotes) {
                vscode_1.commands.executeCommand("vscode.open", vscode_1.Uri.parse('https://marketplace.visualstudio.com/items/well-ar.plantuml/changelog'));
            }
            else if (result === viewDocs) {
                vscode_1.commands.executeCommand("vscode.open", vscode_1.Uri.parse('https://marketplace.visualstudio.com/items/well-ar.plantuml'));
            }
            return result;
        });
    }
